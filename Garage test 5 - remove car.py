...
edit = driver.find_element(By.XPATH, "//button[last()-1]").click()
time.sleep(3)
remove_car = driver.find_element(By.XPATH, "//button[contains(text(),'Remove car')]").click()
time.sleep(3)
remove = driver.find_element(By.XPATH, "//button[contains(text(),'Remove')]").click()
time.sleep(3)

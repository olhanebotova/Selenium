...
mileage = driver.find_element(By.XPATH, "/html/body/app-root/app-global-layout/div/div/div/app-panel-layout/div/div/div/div[2]/div/app-garage/div/div[2]/div/ul/li[1]/app-car/div/div[2]/app-update-mileage-form/form/input").send_keys("1")
time.sleep(3)

update = driver.find_element(By.XPATH, "/html/body/app-root/app-global-layout/div/div/div/app-panel-layout/div/div/div/div[2]/div/app-garage/div/div[2]/div/ul/li[1]/app-car/div/div[2]/app-update-mileage-form/form/button").click()
time.sleep(5)
